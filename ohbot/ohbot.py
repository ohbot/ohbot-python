...
# Copy settings file
if not path.exists('ohbotData/OhbotSettings.xml'):
    ...
    if platform.system() == "Linux":
        ...
        if synthesizer.upper() == "GTTS":
            ...
            if synthesizer.upper() == "FESTIVAL":
                bashcommand = "festival -b '(set! mytext (Utterance Text " + '"' + safetext + '"))' + "' '(utt.synth mytext)' '(utt.save.wave mytext " + '"ohbotData/ohbotspeech.wav")' + "' '(utt.save.segs mytext " + '"ohbotData/phonemes"' + ")'"
            else:
                bashcommand = synthesizer + ' -w ohbotData/ohbotspeech.wav ' + voice + ' "' + safetext + '"'
